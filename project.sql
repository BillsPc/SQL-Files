...
boxName VARCHAR(15) NULL,
boxWallpaper VARCHAR(15) NULL
);
...
CREATE TABLE Towns(
townName VARCHAR(15) NOT NULL PRIMARY KEY,
...
profName VARCHAR(15) NOT NULL PRIMARY KEY,
townName VARCHAR(15) NOT NULL, FOREIGN KEY (townName) REFERENCES Towns (townName)
);
